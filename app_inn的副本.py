...
本月合并底表 = cleanDF资源池(本月合并底表(),name)
上月合并底表 = cleanDF资源池(上月合并底表(),name)
历史底表 = cleanDF资源池(readhistroyData(工时历史总表汇总(), '合并底表'),name)
...
cur_mon_staff = cleanDF资源池(cleanCurMonStaff(本月人员维度()),name)
last_mon_staff = cleanDF资源池(cleanCurMonStaff(上月人员维度()),name)

gpu底表 = cleanDF资源池(历史GPU用户使用情况(),name)
本月gpu底表 = cleanDF资源池(本月gpu底表(),name)
上月gpu底表 = cleanDF资源池(上月gpu底表(),name)
gpu费用 = 历史GPU分区总费用()
本月gpu费用 = 本月gpu费用()
上月gpu费用 = 上月gpu费用()

历史固定资产 = cleanDF资源池(历史固定资产总表(),name)
历史总库存 = 历史总库存()
历史借库 = 历史借库()
本月固定资产 = cleanDF资源池(本月固定资产(),name)
上月固定资产 = cleanDF资源池(上月固定资产(),name)

历史dcp = cleanDF资源池(历史dcp(),name)
本月dcp = cleanDF资源池(本月dcp(),name)
上月dcp = cleanDF资源池(上月dcp(),name)

历史oc = cleanDF资源池(历史oc(),name)
本月oc = cleanDF资源池(本月oc(),name)
上月oc = cleanDF资源池(上月oc(),name)

历史ocUser = cleanDF资源池(历史ocUser(),name)
本月ocUser = cleanDF资源池(本月ocUser(),name)
上月ocUser = cleanDF资源池(上月ocUser(),name)

历史diamond = cleanDF资源池(历史diamond(),name)
本月diamond = cleanDF资源池(本月diamond(),name)
上月diamond = cleanDF资源池(上月diamond(),name)

历史diamondUser = cleanDF资源池(历史diamondUser(),name)
本月diamondUser = cleanDF资源池(本月diamondUser(),name)
上月diamondUser = cleanDF资源池(上月diamondUser(),name)


sumResDf = cleanDF资源池(resAllDfGetCol(历史固定资产, 历史dcpLustre(), 历史dcpCeph(), 历史oc, 历史diamond, gpu底表, gpu费用),name)


indicator_sxibg_num_last = 上月合并底表[上月合并底表['WBS所属部门'].isin(['中东云平台', '智慧综合体', '亚太云平台'])]
indicator_sxibg_num_last = indicator_sxibg_num_last[~indicator_sxibg_num_last['PM姓名'].isin(['谢乃玮'])]
indicator_sxibg_num_cur = 本月合并底表[本月合并底表['WBS所属部门'].isin(['中东云平台', '智慧综合体', '亚太云平台'])]
indicator_sxibg_num_cur = indicator_sxibg_num_cur[~indicator_sxibg_num_cur['PM姓名'].isin(['谢乃玮'])]

indicator_sx_d_num_last = returnWBS_Bl_num(上月WBS维度, 'D', ['中东云平台','智慧综合体','亚太云平台','海外智慧生活与商业'])
indicator_sx_d_num_cur = returnWBS_Bl_num(本月WBS维度, 'D', ['中东云平台','智慧综合体','亚太云平台','海外智慧生活与商业'])
sx_d_number = indicator_wbs_number2(indicator_sx_d_num_cur, indicator_sx_d_num_last, 'SX')

indicator_sx_p_num_last = returnWBS_Bl_num(上月WBS维度, 'P', ['中东云平台','智慧综合体','亚太云平台','海外智慧生活与商业'])
indicator_sx_p_num_cur = returnWBS_Bl_num(本月WBS维度, 'P', ['中东云平台','智慧综合体','亚太云平台','海外智慧生活与商业'])
sx_p_number = indicator_wbs_number2(indicator_sx_p_num_cur, indicator_sx_p_num_last, 'SX')

indicator_sx_r_num_last = returnWBS_Bl_num(上月WBS维度, 'R', ['中东云平台','智慧综合体','亚太云平台','海外智慧生活与商业'])
indicator_sx_r_num_cur = returnWBS_Bl_num(本月WBS维度, 'R', ['中东云平台','智慧综合体','亚太云平台','海外智慧生活与商业'])
sx_r_number = indicator_wbs_number2(indicator_sx_r_num_cur, indicator_sx_r_num_last, 'SX')

indicator_sx_m_num_last = returnWBS_Bl_num(上月WBS维度, 'M', ['中东云平台','智慧综合体','亚太云平台','海外智慧生活与商业'])
indicator_sx_m_num_cur = returnWBS_Bl_num(本月WBS维度, 'M', ['中东云平台','智慧综合体','亚太云平台','海外智慧生活与商业'])
...
indicator_oac_r_num_cur = returnWBS_Bl_num3(indicator_oac_num_cur, 'R', ['运营与赋能中心'],['林智钿'])
...
indicator_oac_m_num_cur = returnWBS_Bl_num3(indicator_oac_num_cur, 'M', ['运营与赋能中心'],['林智钿'])
...
app = Dash(__name__, title="IRDC - 算法SDK资源池 - 工时&资源看板", external_stylesheets=[dbc.themes.SANDSTONE],
...
VALID_USERNAME_PASSWORD_PAIRS = {
    ...
    cyber('Vm0wd2VHUXhTWGhpUm1SWVYwZDRWRmx0ZEhkVlJscDBaVWhrVlUxV2NEQlVWbU0xVmpGS2RHVkVRbUZXVjFKSVZqQmFTMlJIVmtWUmJVWlhWbTVDYjFac1ZtRldNVnBXVFZWV2FHVnFRVGs9'):cyber(
'Vm0wd2VHUXhTWGhpUm1SWVYwZDRWRmx0ZEhkVlJscDBaVWhrVlUxV2NEQlVWbU0xVmpGS2RHVkVRbUZXVjFKSVZqQmFTMlJIVmtWUmJVWlhWbTVDYjFac1ZtRldNVnBXVFZWV2FHVnFRVGs9'
    )
}
...
cur_in_staff_number = len(list(set(filterData(本月合并底表, "员工组", "正式员工")['员工姓名'])))
last_in_staff_number = len(list(set(filterData(上月合并底表, "员工组", "正式员工")['员工姓名'])))
cur_out_staff_number = len(list(set(filterData(本月合并底表, "员工组", "外包员工")['员工姓名'])))
last_out_staff_number = len(list(set(filterData(上月合并底表, "员工组", "外包员工")['员工姓名'])))
cur_intern_staff_number = len(list(set(filterData(本月合并底表, "员工组", "实习生")['员工姓名'])))
last_intern_staff_number = len(list(set(filterData(上月合并底表, "员工组", "实习生")['员工姓名'])))
last_in_actual_day = filterData(上月合并底表, "员工组", "正式员工")['实际人天'].sum()
cur_in_actual_day = filterData(本月合并底表, "员工组", "正式员工")['实际人天'].sum()
last_out_actual_day = filterData(上月合并底表, "员工组", "外包员工")['实际人天'].sum()
cur_out_actual_day = filterData(本月合并底表, "员工组", "外包员工")['实际人天'].sum()
last_intern_actual_day = filterData(上月合并底表, "员工组", "实习生")['实际人天'].sum()
cur_intern_actual_day = filterData(本月合并底表, "员工组", "实习生")['实际人天'].sum()

last_in_lo_day = filterCurMonStaff(上月人员维度(), "员工组", "正式员工")['理论人天'].sum()
cur_in_lo_day = filterCurMonStaff(cur_mon_staff, "员工组", "正式员工")['理论人天'].sum()
last_out_lo_day = filterCurMonStaff(上月人员维度(), "员工组", "外包员工")['理论人天'].sum()
cur_out_lo_day = filterCurMonStaff(cur_mon_staff, "员工组", "外包员工")['理论人天'].sum()
last_intern_lo_day = filterCurMonStaff(上月人员维度(), "员工组", "实习生")['理论人天'].sum()
cur_intern_lo_day = filterCurMonStaff(cur_mon_staff, "员工组", "实习生")['理论人天'].sum()


本月未填工时 = cleanDF资源池(本月未填工时名单(),name)
上月未填工时 = cleanDF资源池(上月未填工时名单(),name)
...
sx_lustre= indicator_bl_total_mid(sxDatalustre, sxDataLastlustre, 'Lustre费用')
ir_lustre= indicator_bl_total_mid(irDatalustre, irDataLastlustre, 'Lustre费用')
dxSku_lustre= indicator_bl_total_mid(dxSkuDatalustre, dxSkuDataLastlustre, 'Lustre费用')
dxTy_lustre= indicator_bl_total_mid(dxTyDatalustre, dxTyDataLastlustre, 'Lustre费用')
mkt_lustre= indicator_bl_total_mid(mktDatalustre, mktDataLastlustre, 'Lustre费用')
oac_lustre= indicator_bl_total_mid(oacDatalustre, oacDataLastlustre, 'Lustre费用')

sx_ceph= indicator_bl_total_mid(sxDataceph, sxDataLastceph, 'Ceph费用')
ir_ceph= indicator_bl_total_mid(irDataceph, irDataLastceph, 'Ceph费用')
dxSku_ceph= indicator_bl_total_mid(dxSkuDataceph, dxSkuDataLastceph, 'Ceph费用')
dxTy_ceph= indicator_bl_total_mid(dxTyDataceph, dxTyDataLastceph, 'Ceph费用')
mkt_ceph= indicator_bl_total_mid(mktDataceph, mktDataLastceph, 'Ceph费用')
oac_ceph= indicator_bl_total_mid(oacDataceph, oacDataLastceph, 'Ceph费用')

sx_oc= indicator_bl_total_mid(sxDataoc, sxDataLastoc, 'OC费用')
ir_oc= indicator_bl_total_mid(irDataoc, irDataLastoc, 'OC费用')
dxSku_oc= indicator_bl_total_mid(dxSkuDataoc, dxSkuDataLastoc, 'OC费用')
dxTy_oc= indicator_bl_total_mid(dxTyDataoc, dxTyDataLastoc, 'OC费用')
mkt_oc= indicator_bl_total_mid(mktDataoc, mktDataLastoc, 'OC费用')
oac_oc= indicator_bl_total_mid(oacDataoc, oacDataLastoc, 'OC费用')

sx_diamond= indicator_bl_total_mid(sxDatadiamond, sxDataLastdiamond, 'Diamond费用')
ir_diamond= indicator_bl_total_mid(irDatadiamond, irDataLastdiamond, 'Diamond费用')
dxSku_diamond= indicator_bl_total_mid(dxSkuDatadiamond, dxSkuDataLastdiamond, 'Diamond费用')
dxTy_diamond= indicator_bl_total_mid(dxTyDatadiamond, dxTyDataLastdiamond, 'Diamond费用')
mkt_diamond= indicator_bl_total_mid(mktDatadiamond, mktDataLastdiamond, 'Diamond费用')
oac_diamond= indicator_bl_total_mid(oacDatadiamond, oacDataLastdiamond, 'Diamond费用')



sx_lustrep = indicator_bl_total_mid(sxDatalustre, sxDataLastlustre, 'Lustre人数')
ir_lustrep = indicator_bl_total_mid(irDatalustre, irDataLastlustre, 'Lustre人数')
dxSku_lustrep = indicator_bl_total_mid(dxSkuDatalustre, dxSkuDataLastlustre, 'Lustre人数')
dxTy_lustrep = indicator_bl_total_mid(dxTyDatalustre, dxTyDataLastlustre, 'Lustre人数')
mkt_lustrep = indicator_bl_total_mid(mktDatalustre, mktDataLastlustre, 'Lustre人数')
oac_lustrep = indicator_bl_total_mid(oacDatalustre, oacDataLastlustre, 'Lustre人数')

sx_cephp = indicator_bl_total_mid(sxDataceph, sxDataLastceph, 'Ceph人数')
ir_cephp = indicator_bl_total_mid(irDataceph, irDataLastceph, 'Ceph人数')
dxSku_cephp = indicator_bl_total_mid(dxSkuDataceph, dxSkuDataLastceph, 'Ceph人数')
dxTy_cephp = indicator_bl_total_mid(dxTyDataceph, dxTyDataLastceph, 'Ceph人数')
mkt_cephp = indicator_bl_total_mid(mktDataceph, mktDataLastceph, 'Ceph人数')
oac_cephp = indicator_bl_total_mid(oacDataceph, oacDataLastceph, 'Ceph人数')

sx_ocp = indicator_bl_total_mid(sxDataoc, sxDataLastoc, 'OC人数')
ir_ocp = indicator_bl_total_mid(irDataoc, irDataLastoc, 'OC人数')
dxSku_ocp = indicator_bl_total_mid(dxSkuDataoc, dxSkuDataLastoc, 'OC人数')
dxTy_ocp = indicator_bl_total_mid(dxTyDataoc, dxTyDataLastoc, 'OC人数')
mkt_ocp = indicator_bl_total_mid(mktDataoc, mktDataLastoc, 'OC人数')
oac_ocp = indicator_bl_total_mid(oacDataoc, oacDataLastoc, 'OC人数')

sx_diamondp = indicator_bl_total_mid(sxDatadiamond, sxDataLastdiamond, 'Diamond人数')
ir_diamondp = indicator_bl_total_mid(irDatadiamond, irDataLastdiamond, 'Diamond人数')
dxSku_diamondp = indicator_bl_total_mid(dxSkuDatadiamond, dxSkuDataLastdiamond, 'Diamond人数')
dxTy_diamondp = indicator_bl_total_mid(dxTyDatadiamond, dxTyDataLastdiamond, 'Diamond人数')
mkt_diamondp = indicator_bl_total_mid(mktDatadiamond, mktDataLastdiamond, 'Diamond人数')
oac_diamondp = indicator_bl_total_mid(oacDatadiamond, oacDataLastdiamond, 'Diamond人数')
...
irDataTotal = try0toNone(int(irData['实际人天'].sum()))
irDataTotalLast = try0toNone(int(irDataLast['实际人天'].sum()))

dxSkuDataTotal = try0toNone(int(dxSkuData['实际人天'].sum()))
dxSkuDataTotalLast = try0toNone(int(dxSkuDataLast['实际人天'].sum()))

dxTyDataTotal = try0toNone(int(dxTyData['实际人天'].sum()))
dxTyDataTotalLast = try0toNone(int(dxTyDataLast['实际人天'].sum()))

mktDataTotal = try0toNone(int(mktData['实际人天'].sum()))
mktDataTotalLast = try0toNone(int(mktDataLast['实际人天'].sum()))

oacDataTotal = try0toNone(int(oacData['实际人天'].sum()))
oacDataTotalLast = try0toNone(int(oacDataLast['实际人天'].sum()))

sxGroup研究 = tryExceptNone(blGroupByTitle(sxData, '岗位名称', '算法研究'))
sxGroup开发 = tryExceptNone(blGroupByTitle(sxData, '岗位名称', '算法开发'))
...
sxGroup研究Last = tryExceptNone(blGroupByTitle(sxDataLast, '岗位名称', '算法研究'))
sxGroup开发Last = tryExceptNone(blGroupByTitle(sxDataLast, '岗位名称', '算法开发'))
...
irGroup研究 = tryExceptNone(blGroupByTitle(irData, '岗位名称', '算法研究'))
irGroup开发 = tryExceptNone(blGroupByTitle(irData, '岗位名称', '算法开发'))
irGroup研究per = tryExceptNone(blGroupByTitlePer(irGroup研究, irData))
irGroup开发per = tryExceptNone(blGroupByTitlePer(irGroup开发, irData))

irGroup研究Last = tryExceptNone(blGroupByTitle(irDataLast, '岗位名称', '算法研究'))
irGroup开发Last = tryExceptNone(blGroupByTitle(irDataLast, '岗位名称', '算法开发'))
irGroup研究perLast = tryExceptNone(blGroupByTitlePer(irGroup研究Last, irDataLast))
irGroup开发perLast = tryExceptNone(blGroupByTitlePer(irGroup开发Last, irDataLast))

dxSkuGroup研究 = tryExceptNone(blGroupByTitle(dxSkuData, '岗位名称', '算法研究'))
dxSkuGroup开发 = tryExceptNone(blGroupByTitle(dxSkuData, '岗位名称', '算法开发'))
dxSkuGroup研究per = tryExceptNone(blGroupByTitlePer(dxSkuGroup研究, dxSkuData))
dxSkuGroup开发per = tryExceptNone(blGroupByTitlePer(dxSkuGroup开发, dxSkuData))

dxSkuGroup研究Last = tryExceptNone(blGroupByTitle(dxSkuDataLast, '岗位名称', '算法研究'))
dxSkuGroup开发Last = tryExceptNone(blGroupByTitle(dxSkuDataLast, '岗位名称', '算法开发'))
dxSkuGroup研究perLast = tryExceptNone(blGroupByTitlePer(dxSkuGroup研究Last, dxSkuDataLast))
dxSkuGroup开发perLast = tryExceptNone(blGroupByTitlePer(dxSkuGroup开发Last, dxSkuDataLast))

dxTyGroup研究 = tryExceptNone(blGroupByTitle(dxTyData, '岗位名称', '算法研究'))
dxTyGroup开发 = tryExceptNone(blGroupByTitle(dxTyData, '岗位名称', '算法开发'))
dxTyGroup研究per = tryExceptNone(blGroupByTitlePer(dxTyGroup研究, dxSkuData))
dxTyGroup开发per = tryExceptNone(blGroupByTitlePer(dxTyGroup开发, dxSkuData))

dxTyGroup研究Last = tryExceptNone(blGroupByTitle(dxTyDataLast, '岗位名称', '算法研究'))
dxTyGroup开发Last = tryExceptNone(blGroupByTitle(dxTyDataLast, '岗位名称', '算法开发'))
dxTyGroup研究perLast = tryExceptNone(blGroupByTitlePer(dxTyGroup研究Last, dxTyDataLast))
dxTyGroup开发perLast = tryExceptNone(blGroupByTitlePer(dxTyGroup开发Last, dxTyDataLast))

mktGroup研究 = tryExceptNone(blGroupByTitle(mktData, '岗位名称', '算法研究'))
mktGroup开发 = tryExceptNone(blGroupByTitle(mktData, '岗位名称', '算法开发'))
mktGroup研究per = tryExceptNone(blGroupByTitlePer(mktGroup研究, mktData))
mktGroup开发per = tryExceptNone(blGroupByTitlePer(mktGroup开发, mktData))

mktGroup研究Last = tryExceptNone(blGroupByTitle(mktDataLast, '岗位名称', '算法研究'))
mktGroup开发Last = tryExceptNone(blGroupByTitle(mktDataLast, '岗位名称', '算法开发'))
mktGroup研究perLast = tryExceptNone(blGroupByTitlePer(mktGroup研究Last, mktDataLast))
mktGroup开发perLast = tryExceptNone(blGroupByTitlePer(mktGroup开发Last, mktDataLast))

oacGroup研究 = tryExceptNone(blGroupByTitle(oacData, '岗位名称', '算法研究'))
oacGroup开发 = tryExceptNone(blGroupByTitle(oacData, '岗位名称', '算法开发'))
oacGroup研究per = tryExceptNone(blGroupByTitlePer(oacGroup研究, oacData))
oacGroup开发per = tryExceptNone(blGroupByTitlePer(oacGroup开发, oacData))

oacGroup研究Last = tryExceptNone(blGroupByTitle(oacDataLast, '岗位名称', '算法研究'))
oacGroup开发Last = tryExceptNone(blGroupByTitle(oacDataLast, '岗位名称', '算法开发'))
oacGroup研究perLast = tryExceptNone(blGroupByTitlePer(oacGroup研究Last, oacDataLast))
...
oac_wh_total = indicator_bl_total(oacDataTotal, oacDataTotalLast, "运赋(RPL) 总人天")

sx_研究 = indicator_bl_total_mid(sxGroup研究, sxGroup研究Last, '算法研究')
ir_研究 = indicator_bl_total_mid(irGroup研究, irGroup研究Last, '算法研究')
dxSku_研究 = indicator_bl_total_mid(dxSkuGroup研究, dxSkuGroup研究Last, '算法研究')
dxTy_研究 = indicator_bl_total_mid(dxTyGroup研究, dxTyGroup研究Last, '算法研究')
mkt_研究 = indicator_bl_total_mid(mktGroup研究, mktGroup研究Last, '算法研究')
oac_研究 = indicator_bl_total_mid(oacGroup研究, oacGroup研究Last, '算法研究')

sx_研究per = indicator_bl_total_mid_rate(sxGroup研究per, sxGroup研究perLast, '占比')
ir_研究per = indicator_bl_total_mid_rate(irGroup研究per, irGroup研究perLast, '占比')
dxSku_研究per = indicator_bl_total_mid_rate(dxSkuGroup研究per, dxSkuGroup研究perLast, '占比')
dxTy_研究per = indicator_bl_total_mid_rate(dxTyGroup研究per, dxTyGroup研究perLast, '占比')
mkt_研究per = indicator_bl_total_mid_rate(mktGroup研究per, mktGroup研究perLast, '占比')
oac_研究per = indicator_bl_total_mid_rate(oacGroup研究per, oacGroup研究perLast, '占比')

sx_开发 = indicator_bl_total_mid(sxGroup开发, sxGroup开发Last, '算法开发')
ir_开发 = indicator_bl_total_mid(irGroup开发, irGroup开发Last, '算法开发')
dxSku_开发 = indicator_bl_total_mid(dxSkuGroup开发, dxSkuGroup开发Last, '算法开发')
dxTy_开发 = indicator_bl_total_mid(dxTyGroup开发, dxTyGroup开发Last, '算法开发')
mkt_开发 = indicator_bl_total_mid(mktGroup开发, mktGroup开发Last, '算法开发')
oac_开发 = indicator_bl_total_mid(oacGroup开发, oacGroup开发Last, '算法开发')

sx_开发per = indicator_bl_total_mid_rate(sxGroup开发per, sxGroup开发perLast, '占比')
ir_开发per = indicator_bl_total_mid_rate(irGroup开发per, irGroup开发perLast, '占比')
dxSku_开发per = indicator_bl_total_mid_rate(dxSkuGroup开发per, dxSkuGroup开发perLast, '占比')
dxTy_开发per = indicator_bl_total_mid_rate(dxTyGroup开发per, dxTyGroup开发perLast, '占比')
mkt_开发per = indicator_bl_total_mid_rate(mktGroup开发per, mktGroup开发perLast, '占比')
oac_开发per = indicator_bl_total_mid_rate(oacGroup开发per, oacGroup开发perLast, '占比')
...
def render_content(tab):
    if tab == '工时':
        return dbc.Container([
            html.P(
                "人员维度工时 ( Data {}; 国内全勤 {} 人天, 新加坡全勤 {} 人天。)".format(
                    人员维度更新时间(), 国内全勤人天(), 新加坡全勤人天())),
            dbc.Row([
                dbc.Col([
            ...
            dbc.Row([
                dbc.Col([
                    ...
                    dbc.Row([
                        irdc_wh_middle("sx_研究_indicator", sx_研究),
                        irdc_wh_middle("sx_研究per_indicator", sx_研究per)
                    ]),
                    dbc.Row([
                        irdc_wh_middle("sx_开发_indicator", sx_开发),
                        irdc_wh_middle("sx_开发per_indicator", sx_开发per)
                    ]),
                ]),
                dbc.Col([
                    dbc.Row([
                    ...
                    dbc.Row([
                        irdc_wh_middle("ir_研究_indicator", ir_研究),
                        irdc_wh_middle("ir_研究per_indicator", ir_研究per)
                    ]),
                    dbc.Row([
                        irdc_wh_middle("ir_开发_indicator", ir_开发),
                        irdc_wh_middle("ir_开发per_indicator", ir_开发per)
                    ]),
                ]),
                dbc.Col([
                    dbc.Row([
                    ...
                    dbc.Row([
                        irdc_wh_middle("dxSku_研究_indicator", dxSku_研究),
                        irdc_wh_middle("dxSku_研究per_indicator", dxSku_研究per)
                    ]),
                    dbc.Row([
                        irdc_wh_middle("dxSku_开发_indicator", dxSku_开发),
                        irdc_wh_middle("dxSku_开发per_indicator", dxSku_开发per)
                    ]),
                ]),
                dbc.Col([
                    dbc.Row([
                    ...
                    dbc.Row([
                        irdc_wh_middle("dxTy_研究_indicator", dxTy_研究),
                        irdc_wh_middle("dxTy_研究per_indicator", dxTy_研究per)
                    ]),
                    dbc.Row([
                        irdc_wh_middle("dxTy_开发_indicator", dxTy_开发),
                        irdc_wh_middle("dxTy_开发per_indicator", dxTy_开发per)
                    ]),
                ]),
                dbc.Col([
                    dbc.Row([
                    ...
                    dbc.Row([
                        irdc_wh_middle("mkt_研究_indicator", mkt_研究),
                        irdc_wh_middle("mkt_研究per_indicator", mkt_研究per)
                    ]),
                    dbc.Row([
                        irdc_wh_middle("mkt_开发_indicator", mkt_开发),
                        irdc_wh_middle("mkt_开发per_indicator", mkt_开发per)
                    ]),
                ]),
                dbc.Col([
                    dbc.Row([
                    ...
                    dbc.Row([
                        irdc_wh_middle("oac_研究_indicator", oac_研究),
                        irdc_wh_middle("oac_研究per_indicator", oac_研究per)
                    ]),
                    dbc.Row([
                        irdc_wh_middle("oac_开发_indicator", oac_开发),
                        irdc_wh_middle("oac_开发per_indicator", oac_开发per)
                    ]),
                ]),
            ]),
            html.Br(),
            html.Div(
                dbc.Accordion([
                    dbc.AccordionItem([
                        dbc.Row([
                            dbc.Col([
                                irdc_graph('员工所属部门汇总-summary', fig员工所属部门汇总byFilterP(staff_apartment_table(cleanDF资源池(cur_mon_staff,name))))
                            ], xs=12, sm=12, md=6, lg=6, xl=6),
                            dbc.Col([
                                irdc_graph('员工所属部门汇总-bar', fig员工所属部门人均人天byFilterP(staff_apartment_table(cleanDF资源池(cur_mon_staff,name))))
                            ], xs=12, sm=12, md=6, lg=6, xl=6),
                            html.Br(),
                            dbc.Row([
                                dash_table_not_collapse("apartment_wh",staff_apartment_table(cleanDF资源池(cur_mon_staff,name))),
                                html.Br(),
                            ]),
                            html.Br(),
                            html.Br(),
                            dbc.Row([
                                irdc_graph('业务线汇总-pie', fig业务线pie资源池(name)),
                            ]),
                            html.Br(),
                            dbc.Row([
                                dbc.Col([
                        ...
                        dbc.Row([
                            dbc.Col([
                                dfExistDfStr(cleanDF资源池(logic_rate_abnormal_tb(), name), '本月工时填报异常人数: '),
                                dfExistDf(cleanDF资源池(logic_rate_abnormal_tb(), name), 'logic_distribution_tb_id'),
                            ]),
                            dbc.Col([
                                dfExistDfStr(cleanDF资源池(本月未填工时名单(), name), '本月未填工时人数（连续两月未填已标蓝): '),
                                dfExistDf(cleanDF资源池(not_fill_workHour_twice(), name), 'no_actual_list_tb_id'),
                            ]),
                        ]),
                        html.Br(),
                        dbc.Col([
                            ...
                            #              '本月非正常工作日填报工时：'),
                            html.P(
                                '本月非正常工作日填报工时人数 (以"员工工作地点"与"行政放假安排"判定是否为当地工作日): '+str(len(cleanDF资源池(not_fill_wh(), name))), style={"fontSize": 25}),
                            dfExistDfLeftAlign(cleanDF资源池(not_fill_wh(), name).iloc[:, 0:-2], 'wired_date_tb_id'),
                        ]),
                        html.Br(),
                        dbc.Row([
                            html.P('本月工时填报人员明细（按实际人天倒序排序）', style={"fontSize": 25}),
                        ]),
                        dbc.Row([
                            dash_table_not_collapse("cur_mon_staff_detailed",
                                                    cur_mon_staff.iloc[:, 0:-4].sort_values(by=['实际人天']).reset_index(drop=True)),
                        ]),
                        html.Br(),
                        html.Br(),
                        html.P(
            ...
            html.Div(
                dbc.Accordion([
                    dbc.AccordionItem([
                        dbc.Row([
                            dbc.Col([
                                irdc_graph('WBS部门Top5-bar', figWBS部门Top(本月WBS维度))
                            ], xs=12, sm=12, md=6, lg=6, xl=6),
                            dbc.Col([
                                irdc_graph('WBS实际人天Top5-pie', figWBStop填报分布Filter(wbs_top_distributionFilter(本月WBS维度)))
                            ], xs=12, sm=12, md=6, lg=6, xl=6),
                        ]),
                        dbc.Row([
                        ...
                        html.Br(),
                        html.P("非PL111WBS的工时投入明细（按照实际人天倒序排序）", style={"fontSize": 25}),
                        dash_table_not_collapse_showAll("wbsX类工时投入明细table",
                                                        cleanDF资源池(notPL111wbsTypeFilter(name).iloc[:, 0:-2].sort_values(by=['实际人天'],ascending=False).reset_index(drop=True),name)),
                        html.Br(),
                        html.Br(),
                        # dbc.Row([
        ...
        return dbc.Container([
            ...
            dbc.Row([
                dbc.Col([
                    dbc.Row([
                        irdc_wh_largeGpu("total_gpu_indicator", total_gpu)
                    ]),
                    dbc.Row([
                    ...
                    dbc.Row([
                        irdc_wh_middleGpu("ir_fee_indicator", ir_fee),
                        irdc_wh_middleGpu("ir_p_indicator", ir_p)
                    ]),
                ...
                dbc.Col([
                    dbc.Row([
                        irdc_wh_largeGpu("total_gpu1080T_indicator", total_gpu1080T)
                    ]),
                    dbc.Row([
                    ...
                    dbc.Row([
                        irdc_wh_middleGpu("ir_1080T_fee_indicator", ir_1080T_fee),
                        irdc_wh_middleGpu("ir_1080T_p_indicator", ir_1080T_p)
                    ]),

                ]),
                dbc.Col([
                    dbc.Row([
                        irdc_wh_largeGpu("total_gpuV100_indicator", total_gpuV100)
                    ]),
                    dbc.Row([
                    ...
                    dbc.Row([
                        irdc_wh_middleGpu("ir_V100_fee_indicator", ir_V100_fee),
                        irdc_wh_middleGpu("ir_V100_p_indicator", ir_V100_p)
                    ]),

                ]),
                dbc.Col([
                    dbc.Row([
                        irdc_wh_largeGpu("total_gpuA100_indicator", total_gpuA100)
                    ]),
                    dbc.Row([
                    ...
                    dbc.Row([
                        irdc_wh_middleGpu("ir_A100_fee_indicator", ir_A100_fee),
                        irdc_wh_middleGpu("ir_A100_p_indicator", ir_A100_p)
                    ]),
                ]),
            ]),
            html.Br(),
            ...
            dbc.Row([
                dbc.Col([
                    ...
                    dbc.Row([
                        ...
                        irdc_wh_middle("sx_笔记本电脑c_indicator", sx_lustrep)
                    ]),
                    dbc.Row([
                        irdc_wh_middle("sx_台式电脑_indicator", sx_ceph),
                        irdc_wh_middle("sx_台式电脑c_indicator", sx_cephp)
                    ]),
                    # dbc.Row([
                ...
                dbc.Col([
                    ...
                    dbc.Row([
                        ...
                        irdc_wh_middle("ir_笔记本电脑c_indicator", ir_lustrep)
                    ]),
                    dbc.Row([
                        irdc_wh_middle("ir_台式电脑_indicator", ir_ceph),
                        irdc_wh_middle("ir_台式电脑c_indicator", ir_cephp)
                    ]),
                    # dbc.Row([
                ...
                dbc.Col([
                    ...
                    dbc.Row([
                        ...
                        irdc_wh_middle("mkt_笔记本电脑c_indicator", mkt_lustrep)
                    ]),
                    dbc.Row([
                        irdc_wh_middle("mkt_台式电脑_indicator", mkt_ceph),
                        irdc_wh_middle("mkt_台式电脑c_indicator", mkt_cephp)
                    ]),
                    # dbc.Row([
                ...
                dbc.Col([
                    ...
                    dbc.Row([
                        ...
                        irdc_wh_middle("oac_笔记本电脑c_indicator", oac_lustrep)
                    ]),
                    dbc.Row([
                        irdc_wh_middle("oac_台式电脑_indicator", oac_ceph),
                        irdc_wh_middle("oac_台式电脑c_indicator", oac_cephp)
                    ]),
                    # dbc.Row([
            ...
            dbc.Row([
                ...
                dbc.Col([
                    dcc.Dropdown(
                        ...
                        options=[{'label': opt, 'value': opt} for opt in list(set(sumResDf['员工所属部门']))],
                        value=list(set(sumResDf['员工所属部门']))[0],
                        placeholder="选择员工所属部门",
                        clearable=False,
                        style={"width": "100%"},
                    ),
                ], xs=12, sm=12, md=10, lg=10, xl=10),
...
def update_bar_chart2(slider_range):
    low, high = slider_range
...
def build_graph_bl_wl(attri):
    if attri == 'graph_员工组人天':
        return fig员工部门员工组资源池细分(name)
    elif attri == 'graph_岗位名称人天':
        return fig员工部门岗位名称资源池细分(name)
...
def build_table_bl_wl2(attri):
    if attri == 'graph_员工组人天':
        return df0Beautfy(groupByWl(cur_mon_staff,
                                    {'创新孵化-体育': [],
                                     '创新孵化-冰箱': [],
                                     '市场拓展部': [],
                                     '智慧娱乐': [],
...
def build_WBSgraphX_bl_wl(attri):
    if attri == 'graph_wbsX员工组人天':
        return fig员工部门不同维度wbs(对比部门汇总2(notPL111wbsTypeFilter(name), '实际人天', "员工组"), "员工组",
                                      '员工所属部门员工组投入非PL111WBS实际人天')
    elif attri == 'graph_wbsX资源池人天':
        return fig员工部门不同维度wbs(对比部门汇总2(notPL111wbsTypeFilter(name), '实际人天', "资源池"), "资源池",
                                      '员工所属部门资源池投入非PL111WBS实际人天')
    elif attri == 'graph_wbsX岗位名称人天':
        return fig员工部门不同维度wbs(对比部门汇总2(notPL111wbsTypeFilter(name), '实际人天', "岗位名称"), "岗位名称",
                                      '员工所属部门岗位名称投入非PL111WBS实际人天')
    elif attri == 'graph_wbsX员工姓名人天':
        return fig员工部门不同维度wbs(对比部门汇总2(notPL111wbsTypeFilter(name), '实际人天', "员工姓名"), "员工姓名",
...
# )
# def build_WBSgraphX_bl_wl2(attri):
#     if attri == 'graph_wbsX员工组人天2':
#         return fig员工部门不同维度wbs2(对比部门汇总3(notPL111wbsTypeFilter(name), '实际人天', "员工组"), "员工组",
#                                        '资源池员工组投入非PL111WBS实际人天')
#     elif attri == 'graph_wbsX员工所属部门人天2':
#         return fig员工部门不同维度wbs2(对比部门汇总3(notPL111wbsTypeFilter(name), '实际人天', "员工所属部门"), "员工所属部门",
#                                        '资源池员工所属部门投入非PL111WBS实际人天')
#     elif attri == 'graph_wbsX岗位名称人天2':
#         return fig员工部门不同维度wbs2(对比部门汇总3(notPL111wbsTypeFilter(name), '实际人天', "岗位名称"), "岗位名称",
#                                        '资源池岗位名称投入非PL111WBS实际人天')
#     elif attri == 'graph_wbsX员工姓名人天2':
#         return fig员工部门不同维度wbs2(对比部门汇总3(notPL111wbsTypeFilter(name), '实际人天', "员工姓名"), "员工姓名",
...
#
# @app.callback(
#     Output('graph_借库金额', 'figure'),
#     [Input(component_id='radio_借库金额', component_property='value'),
#     Input(component_id='radio_借库金额全选项', component_property='value'),]
# )
# def build_借库金额(allChoice):
#     if allChoice == '借库人二级部门':
#         return fig固定资产detail不同月(对比总库存固定资产(历史总库存, '成本总价', '借库人二级部门'), '借库人二级部门', '历史借库金额', '借库人二级部门', '金额占比', '资产月份')
#     if allChoice == '物料名称':
#         return fig固定资产detail不同月(对比总库存固定资产(历史总库存, '成本总价', '物料名称'), '物料名称', '历史借库金额', '物料名称', '金额占比', '资产月份')
#     if allChoice == '逾期状态':
#         return fig固定资产detail不同月(对比总库存固定资产(历史总库存, '成本总价', '逾期状态'), '逾期状态', '历史借库金额', '逾期状态', '金额占比', '资产月份')
#     if allChoice == '业务类型':
#         return fig固定资产detail不同月(对比总库存固定资产(历史总库存, '成本总价', '业务类型'), '业务类型', '历史借库金额', '业务类型', '金额占比', '资产月份')
#     if allChoice == '借库人BG':
#         return fig固定资产detail不同月(对比总库存固定资产(历史总库存, '成本总价', '借库人BG'), '借库人BG', '历史借库金额', '借库人BG', '金额占比', '资产月份')
#     if allChoice == '物料描述':
#         return fig固定资产detail不同月(对比总库存固定资产(历史总库存, '成本总价', '物料描述'), '物料描述', '历史借库金额', '物料描述', '金额占比', '资产月份')
#



# @app.callback(
#     Output('graph_借库个数', 'figure'),
#     [Input(component_id='radio_借库个数', component_property='value'),
#     Input(component_id='radio_借库个数全选项', component_property='value'),]
# )
# def build_借库个数(allChoice):
#     if allChoice == '借库人二级部门':
#         return fig固定资产detail不同月(对比总库存固定资产数量(历史总库存, '未退回数量', '借库人二级部门'), '借库人二级部门', '历史借库个数', '借库人二级部门', '个数占比', '资产月份')
#     if allChoice == '物料名称':
#         return fig固定资产detail不同月(对比总库存固定资产数量(历史总库存, '未退回数量', '物料名称'), '物料名称', '历史借库个数', '物料名称', '个数占比', '资产月份')
#     if allChoice == '逾期状态':
#         return fig固定资产detail不同月(对比总库存固定资产数量(历史总库存, '未退回数量', '逾期状态'), '逾期状态', '历史借库个数', '逾期状态', '个数占比', '资产月份')
#     if allChoice == '业务类型':
#         return fig固定资产detail不同月(对比总库存固定资产数量(历史总库存, '未退回数量', '业务类型'), '业务类型', '历史借库个数', '业务类型', '个数占比', '资产月份')
#     if allChoice == '借库人BG':
#         return fig固定资产detail不同月(对比总库存固定资产数量(历史总库存, '未退回数量', '借库人BG'), '借库人BG', '历史借库个数', '借库人BG', '个数占比', '资产月份')
#     if allChoice == '物料描述':
#         return fig固定资产detail不同月(对比总库存固定资产数量(历史总库存, '未退回数量', '物料描述'), '物料描述', '历史借库个数', '物料描述', '个数占比', '资产月份')
#
...
def build_graph_dcpPie(allchoice):
    ...
    dataNew = 本月dcp
    if allchoice == '员工部门':
        return figDcppie(dataLast, '员工所属部门', dataNew, "部门DCP总费用占比-月度环比")
    if allchoice == '资源池':
        return figDcppie(dataLast, '资源池', dataNew, "部门DCP总费用占比-月度环比")
    if allchoice == '集群名称':
...
def staffHistoricalRes(value):
    if value == '员工所属部门':
        options = list(set(sumResDf['员工所属部门']))
        value = options[0]
    # if value == '资源池':
...
def staffHistoricalRes2(radio, value):
    if radio == '员工所属部门':
        options = list(set(sumResDf[sumResDf['员工所属部门'] == value]['用户名']))
        value = options[0]
    if radio == '资源池':
